        ...
        <article class="faq">
            ...
            <div class="question_answer">
                ...
                <script>
                    ...
                    function DBread() {
                        callWebpage("http://192.168.43.23/Admin/testframe/TestReadData.php"); 
                    ...
                    function saveTenTags() {
                        callWebpage("http://192.168.43.23/Admin/testframe/testWriteData.php?tag="+(countSave+1)+"&test=1");
                        document.getElementById('teststate').innerHTML = "Speichern läuft..."+(countSave+1);		
                        countSave++;
                        if (countSave<10) { 
                            setTimeout(saveTenTags, 500); 
                        }
                ...
                <div class="question_answer">
                    ...
                    <p>
                        <?php
                            ...
                            if ($res->num_rows > 0) {
                                while($i = $res->fetch_assoc()) {
                                    echo "tag: " . $i["TAG"] . " ---- Zugang: " . $i["ZUGANG"] . " ---- " . $i["DATUM"] . "<br>";
                                }
                            }
                            else {
                                echo "Leere Datenbank";
